...
<script type="text/javascript" src="${ctx}/js/system/invitecode/add.js">
...
<body>
	...
	<form id="form" name="form" class="form-horizontal" method="post"
		action="${ctx}/invitecode/addEntity.shtml">
		...
		<input type="hidden" class="form-control checktitle"
						name="inviteCodeFormMap.DeleteFlag" id="DeleteFlag" value="0">
	</form>
