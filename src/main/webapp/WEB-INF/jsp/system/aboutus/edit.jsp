...
<body>
	...
	<form id="form" name="form" class="form-horizontal" method="post"
		...
		<div class="panel-body">
			...
			<input type="hidden" class="form-control checkacc" value="${aboutus.id}"
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<textarea class="form-control checkacc" placeholder="请输入内容" name="aboutUsFormMap.content" id="content" rows="15">${aboutus.content}</textarea>
				</div>
			</div>
		</div>	
